...
Elegir: GitHub.com → HTTPS → Login with browser.
...
Si el nombre `SAVT` ya está ocupado en su cuenta:
...
1. Entrar en [https://share.streamlit.io](https://share.streamlit.io) con la misma cuenta de GitHub.
2. Clic en **Create app** (o **New app**).
3. Completar:
...
- Python 3.10+ (definido en `packages.toml`).
